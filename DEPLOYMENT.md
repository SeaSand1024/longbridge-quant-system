...
**长桥SDK状态**:
- 服务器Python版本: 3.6.8 (CentOS 7默认)
- longbridge SDK要求: Python 3.7+
- 当前运行模式: **模拟模式** (完全可用)
- SDK状态: 完全可选,不影响系统运行
...
- ✅ 监控和策略功能完整
- ✅ 只是交易数据为模拟值
- ✅ 系统已优化: SDK缺失时优雅降级到模拟模式

**如需启用真实交易** - 方案选择:

**方案1: 迁移到新服务器** (推荐)
- 选择Ubuntu 20.04+或CentOS 8+的新服务器
- 默认Python 3.8+,直接安装longbridge SDK即可
...
**当前建议**:
继续使用模拟模式进行开发和测试,生产环境建议使用方案1迁移到新服务器。
